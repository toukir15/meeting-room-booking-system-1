    ...
    <div className="min-h-[calc(100vh-110px)] pt-10 pb-20 lg:pb-0 lg:pt-0 w-full flex lg:justify-center items-center container mx-auto">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row w-full md:items-center mb-2 md:mb-6">
          ...
          <Select
            className="border py-2 lg:py-2.5 lg:lg:w-[70%] text-black outline-none  px-3 rounded text-sm border-gray-300 hover:border-gray-400 transition duration-200 shadow"
            showSearch
        ...
        <div className="flex flex-col md:flex-row w-full md:items-center mb-2 md:mb-6">
          ...
          <div className="lg:w-[70%] flex flex-col">
            <input
              ...
              className="border py-2 lg:py-2.5 lg:w-[100%] text-black outline-none  px-3 rounded text-sm border-gray-300  transition duration-200 shadow"
              type="number"
              disabled
              placeholder="Room no"
            />
        ...
        <div className="flex flex-col md:flex-row w-full md:items-center mb-2 md:mb-6">
          ...
          <TimePicker
            className="py-2.5 outline-none lg:w-[70%]"
            value={
              selectedStartTime
        ...
        <div className="flex flex-col md:flex-row w-full md:items-center">
          ...
          <div className="md:lg:lg:w-[70%] flex gap-6">
            <button
              type="submit"
