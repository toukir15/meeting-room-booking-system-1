...
const createRoomIntoDB = (roomData, files) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    files.map((file) =>
      __awaiter(void 0, void 0, void 0, function* () {
        const { secure_url } = yield (0,
        sendImageToCloudinary_1.sendImageToCloudinary)(
          file.filename,
          file.path,
        );
        yield room_model_1.Room.findByIdAndUpdate(result._id, {
...
const getSingleRoomFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield room_model_1.Room.findById(id);
    return result;
  });
const updateRoomIntoDB = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteRoomIntoDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isDeleted = yield room_model_1.Room.findOne({
      _id: id,
      isDeleted: true,
    });
    ...
    const result = yield room_model_1.Room.findByIdAndUpdate(
      id,
      { isDeleted: true },
      {
        new: true,
